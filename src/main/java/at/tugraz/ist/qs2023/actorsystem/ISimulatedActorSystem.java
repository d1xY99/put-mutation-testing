package at.tugraz.ist.qs2023.actorsystem;

import at.tugraz.ist.qs2023.messageboard.UnknownClientException;
import at.tugraz.ist.qs2023.messageboard.UnknownMessageException;
...
public interface ISimulatedActorSystem {
     ...
     */
    void runFor(int numberOfTicks) throws UnknownClientException, UnknownMessageException;
     ...
     */
    void runUntil(int endTime) throws UnknownClientException, UnknownMessageException;
     ...
     */
    void tick() throws UnknownClientException, UnknownMessageException;
